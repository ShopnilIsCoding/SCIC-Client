    ...
    useEffect(() => {
        const fetchBrandsAndCategories = async () => {
            try {
                ...
                const brandResponse = await axios.get('https://scic-server-eight.vercel.app/api/brands');
                const categoryResponse = await axios.get('https://scic-server-eight.vercel.app/api/categories');
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const response = await axios.get('https://scic-server-eight.vercel.app/api/products', {
                    params: {
                        page,
                        limit: 10,
                        search: searchTerm,
